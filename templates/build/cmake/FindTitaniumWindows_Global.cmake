...
set_target_properties(TitaniumWindows_Global PROPERTIES
  ...
  INTERFACE_INCLUDE_DIRECTORIES "${WINDOWS_SOURCE_DIR}/lib/TitaniumWindows_Global/include;$<TARGET_PROPERTY:TitaniumKit,INTERFACE_INCLUDE_DIRECTORIES>"
  INTERFACE_LINK_LIBRARIES "TitaniumKit"
  INTERFACE_TitaniumWindows_Global_MAJOR_VERSION "0"
)

set_target_properties(TitaniumWindows_Global PROPERTIES
  IMPORTED_IMPLIB "${WINDOWS_SOURCE_DIR}/lib/TitaniumWindows_Global/${TitaniumWindows_Global_ARCH}/TitaniumWindows_Global.lib"
  IMPORTED_LOCATION "${WINDOWS_SOURCE_DIR}/lib/TitaniumWindows_Global/${TitaniumWindows_Global_ARCH}/TitaniumWindows_Global.dll"
  )
