...
describe('Ti.UI constants', function () {
    ...
    it("Ti.UI.FACE_DOWN", function (finish) {
        should(Ti.UI.FACE_DOWN).be.a.Number;
        finish();
    });
    it("Ti.UI.RETURNKEY_GO", function (finish) {
        should(Ti.UI.RETURNKEY_GO).be.a.Number;
        finish();
    });
    it("Ti.UI.RETURNKEY_GOOGLE", function (finish) {
        should(Ti.UI.RETURNKEY_GOOGLE).be.a.Number;
        finish();
    });
    it("Ti.UI.RETURNKEY_JOIN", function (finish) {
        should(Ti.UI.RETURNKEY_JOIN).be.a.Number;
        finish();
    });
    it("Ti.UI.RETURNKEY_NEXT", function (finish) {
        should(Ti.UI.RETURNKEY_NEXT).be.a.Number;
        finish();
    });
    it("Ti.UI.RETURNKEY_ROUTE", function (finish) {
        should(Ti.UI.RETURNKEY_ROUTE).be.a.Number;
        finish();
    });
    it("Ti.UI.RETURNKEY_SEARCH", function (finish) {
        should(Ti.UI.RETURNKEY_SEARCH).be.a.Number;
        finish();
    });
    it("Ti.UI.RETURNKEY_YAHOO", function (finish) {
        should(Ti.UI.RETURNKEY_YAHOO).be.a.Number;
        finish();
    });
    it("Ti.UI.RETURNKEY_DONE", function (finish) {
        should(Ti.UI.RETURNKEY_DONE).be.a.Number;
        finish();
    });
    it("Ti.UI.RETURNKEY_EMERGENCY_CALL", function (finish) {
        should(Ti.UI.RETURNKEY_EMERGENCY_CALL).be.a.Number;
        finish();
    });
    it("Ti.UI.RETURNKEY_DEFAULT", function (finish) {
        should(Ti.UI.RETURNKEY_DEFAULT).be.a.Number;
        finish();
    });
    it("Ti.UI.RETURNKEY_SEND", function (finish) {
        should(Ti.UI.RETURNKEY_SEND).be.a.Number;
        finish();
    });
    it("Ti.UI.KEYBOARD_APPEARANCE_DEFAULT", function (finish) {
        should(Ti.UI.KEYBOARD_APPEARANCE_DEFAULT).be.a.Number;
        finish();
    });
    it("Ti.UI.KEYBOARD_APPEARANCE_ALERT", function (finish) {
        should(Ti.UI.KEYBOARD_APPEARANCE_ALERT).be.a.Number;
        finish();
    });
    it("Ti.UI.KEYBOARD_ASCII", function (finish) {
        should(Ti.UI.KEYBOARD_ASCII).be.a.Number;
        finish();
    });
    it("Ti.UI.KEYBOARD_NUMBERS_PUNCTUATION", function (finish) {
        should(Ti.UI.KEYBOARD_NUMBERS_PUNCTUATION).be.a.Number;
        finish();
    });
    it("Ti.UI.KEYBOARD_URL", function (finish) {
        should(Ti.UI.KEYBOARD_URL).be.a.Number;
        finish();
    });
    it("Ti.UI.KEYBOARD_NUMBER_PAD", function (finish) {
        should(Ti.UI.KEYBOARD_NUMBER_PAD).be.a.Number;
        finish();
    });
    it("Ti.UI.KEYBOARD_PHONE_PAD", function (finish) {
        should(Ti.UI.KEYBOARD_PHONE_PAD).be.a.Number;
        finish();
    });
    it("Ti.UI.KEYBOARD_EMAIL", function (finish) {
        should(Ti.UI.KEYBOARD_EMAIL).be.a.Number;
        finish();
    });
    it("Ti.UI.KEYBOARD_NAMEPHONE_PAD", function (finish) {
        should(Ti.UI.KEYBOARD_NAMEPHONE_PAD).be.a.Number;
        finish();
    });
    it("Ti.UI.KEYBOARD_DEFAULT", function (finish) {
        should(Ti.UI.KEYBOARD_DEFAULT).be.a.Number;
        finish();
    });
    it("Ti.UI.KEYBOARD_DECIMAL_PAD", function (finish) {
        should(Ti.UI.KEYBOARD_DECIMAL_PAD).be.a.Number;
        finish();
    });
    it("Ti.UI.AUTOLINK_EMAIL_ADDRESSES", function (finish) {
        should(Ti.UI.AUTOLINK_EMAIL_ADDRESSES).be.a.Number;
        finish();
    });
    it("Ti.UI.AUTOLINK_MAP_ADDRESSES", function (finish) {
        should(Ti.UI.AUTOLINK_MAP_ADDRESSES).be.a.Number;
        finish();
    });
    it("Ti.UI.AUTOLINK_PHONE_NUMBERS", function (finish) {
        should(Ti.UI.AUTOLINK_PHONE_NUMBERS).be.a.Number;
        finish();
    });
    it("Ti.UI.AUTOLINK_URLS", function (finish) {
        should(Ti.UI.AUTOLINK_URLS).be.a.Number;
        finish();
    });
    it("Ti.UI.AUTOLINK_NONE", function (finish) {
        should(Ti.UI.AUTOLINK_NONE).be.a.Number;
        finish();
    });
    it("Ti.UI.AUTOLINK_ALL", function (finish) {
        should(Ti.UI.AUTOLINK_ALL).be.a.Number;
        finish();
    });
    it("Ti.UI.INPUT_BORDERSTYLE_NONE", function (finish) {
        should(Ti.UI.INPUT_BORDERSTYLE_NONE).be.a.Number;
        finish();
    });
    it("Ti.UI.INPUT_BORDERSTYLE_ROUNDED", function (finish) {
        should(Ti.UI.INPUT_BORDERSTYLE_ROUNDED).be.a.Number;
        finish();
    });
    it("Ti.UI.INPUT_BORDERSTYLE_BEZEL", function (finish) {
        should(Ti.UI.INPUT_BORDERSTYLE_BEZEL).be.a.Number;
        finish();
    });
    it("Ti.UI.INPUT_BORDERSTYLE_LINE", function (finish) {
        should(Ti.UI.INPUT_BORDERSTYLE_LINE).be.a.Number;
        finish();
    });
    it("Ti.UI.INPUT_BUTTONMODE_ONFOCUS", function (finish) {
        should(Ti.UI.INPUT_BUTTONMODE_ONFOCUS).be.a.Number;
        finish();
    });
    it("Ti.UI.INPUT_BUTTONMODE_ALWAYS", function (finish) {
        should(Ti.UI.INPUT_BUTTONMODE_ALWAYS).be.a.Number;
        finish();
    });
    it("Ti.UI.INPUT_BUTTONMODE_NEVER", function (finish) {
        should(Ti.UI.INPUT_BUTTONMODE_NEVER).be.a.Number;
        finish();
    });
    it("Ti.UI.LIST_ITEM_TEMPLATE_DEFAULT", function (finish) {
        should(Ti.UI.LIST_ITEM_TEMPLATE_DEFAULT).be.a.String;
        finish();
    });
    it("Ti.UI.LIST_ACCESSORY_TYPE_NONE", function (finish) {
        should(Ti.UI.LIST_ACCESSORY_TYPE_NONE).be.a.Number;
        finish();
    });
    it("Ti.UI.LIST_ACCESSORY_TYPE_CHECKMARK", function (finish) {
        should(Ti.UI.LIST_ACCESSORY_TYPE_CHECKMARK).be.a.Number;
        finish();
    });
    it("Ti.UI.LIST_ACCESSORY_TYPE_DETAIL", function (finish) {
        should(Ti.UI.LIST_ACCESSORY_TYPE_DETAIL).be.a.Number;
        finish();
    });
    it("Ti.UI.LIST_ACCESSORY_TYPE_DISCLOSURE", function (finish) {
        should(Ti.UI.LIST_ACCESSORY_TYPE_DISCLOSURE).be.a.Number;
        finish();
    });
    it("Ti.UI.MAP_VIEW_STANDARD", function (finish) {
        should(Ti.UI.MAP_VIEW_STANDARD).be.a.Number;
        finish();
    });
    it("Ti.UI.MAP_VIEW_SATELLITE", function (finish) {
        should(Ti.UI.MAP_VIEW_SATELLITE).be.a.Number;
        finish();
    });
    it("Ti.UI.MAP_VIEW_HYBRID", function (finish) {
        should(Ti.UI.MAP_VIEW_HYBRID).be.a.Number;
        finish();
    });
    it("Ti.UI.TABLEVIEW_POSITION_ANY", function (finish) {
        should(Ti.UI.TABLEVIEW_POSITION_ANY).be.a.Number;
        finish();
    });
    it("Ti.UI.TABLEVIEW_POSITION_TOP", function (finish) {
        should(Ti.UI.TABLEVIEW_POSITION_TOP).be.a.Number;
        finish();
    });
    it("Ti.UI.TABLEVIEW_POSITION_MIDDLE", function (finish) {
        should(Ti.UI.TABLEVIEW_POSITION_MIDDLE).be.a.Number;
        finish();
    });
    it("Ti.UI.TABLEVIEW_POSITION_BOTTOM", function (finish) {
        should(Ti.UI.TABLEVIEW_POSITION_BOTTOM).be.a.Number;
        finish();
    });
    it("Ti.UI.TEXT_ALIGNMENT_LEFT", function (finish) {
        should(Ti.UI.TEXT_ALIGNMENT_LEFT).be.a.String;
        finish();
    });
    it("Ti.UI.TEXT_ALIGNMENT_CENTER", function (finish) {
        should(Ti.UI.TEXT_ALIGNMENT_CENTER).be.a.String;
        finish();
    });
    it("Ti.UI.TEXT_ALIGNMENT_RIGHT", function (finish) {
        should(Ti.UI.TEXT_ALIGNMENT_RIGHT).be.a.String;
        finish();
    });
    it("Ti.UI.TEXT_VERTICAL_ALIGNMENT_BOTTOM", function (finish) {
        should(Ti.UI.TEXT_VERTICAL_ALIGNMENT_BOTTOM).be.a.String;
        finish();
    });
    it("Ti.UI.TEXT_VERTICAL_ALIGNMENT_CENTER", function (finish) {
        should(Ti.UI.TEXT_VERTICAL_ALIGNMENT_CENTER).be.a.String;
        finish();
    });
    it("Ti.UI.TEXT_VERTICAL_ALIGNMENT_TOP", function (finish) {
        should(Ti.UI.TEXT_VERTICAL_ALIGNMENT_TOP).be.a.String;
        finish();
    });
    it("Ti.UI.PICKER_TYPE_PLAIN", function (finish) {
        should(Ti.UI.PICKER_TYPE_PLAIN).be.a.Number;
        finish();
    });
    it("Ti.UI.PICKER_TYPE_TIME", function (finish) {
        should(Ti.UI.PICKER_TYPE_TIME).be.a.Number;
        finish();
    });
    it("Ti.UI.PICKER_TYPE_DATE", function (finish) {
        should(Ti.UI.PICKER_TYPE_DATE).be.a.Number;
        finish();
    });
    it("Ti.UI.PICKER_TYPE_DATE_AND_TIME", function (finish) {
        should(Ti.UI.PICKER_TYPE_DATE_AND_TIME).be.a.Number;
        finish();
    });
    it("Ti.UI.PICKER_TYPE_COUNT_DOWN_TIMER", function (finish) {
        should(Ti.UI.PICKER_TYPE_COUNT_DOWN_TIMER).be.a.Number;
        finish();
    });
    it("Ti.UI.TEXT_AUTOCAPITALIZATION_NONE", function (finish) {
        should(Ti.UI.TEXT_AUTOCAPITALIZATION_NONE).be.a.Number;
        finish();
    });
    it("Ti.UI.TEXT_AUTOCAPITALIZATION_SENTENCES", function (finish) {
        should(Ti.UI.TEXT_AUTOCAPITALIZATION_SENTENCES).be.a.Number;
        finish();
    });
    it("Ti.UI.TEXT_AUTOCAPITALIZATION_WORDS", function (finish) {
        should(Ti.UI.TEXT_AUTOCAPITALIZATION_WORDS).be.a.Number;
        finish();
    });
    it("Ti.UI.TEXT_AUTOCAPITALIZATION_ALL", function (finish) {
        should(Ti.UI.TEXT_AUTOCAPITALIZATION_ALL).be.a.Number;
        finish();
    });
    it("Ti.UI.UNIT_PX", function (finish) {
        should(Ti.UI.UNIT_PX).be.a.String;
        finish();
    });
    it("Ti.UI.UNIT_MM", function (finish) {
        should(Ti.UI.UNIT_MM).be.a.String;
        finish();
    });
    it("Ti.UI.UNIT_CM", function (finish) {
        should(Ti.UI.UNIT_CM).be.a.String;
        finish();
    });
    it("Ti.UI.UNIT_IN", function (finish) {
        should(Ti.UI.UNIT_IN).be.a.String;
        finish();
    });
    it("Ti.UI.UNIT_DIP", function (finish) {
