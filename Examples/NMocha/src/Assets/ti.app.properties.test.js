...
describe('Titanium.App.Properties', function () {
	...
	it.skip('setBool on property from tiapp doesnt change value', function () {
	...
	it.skip('setDouble on property from tiapp doesnt change value', function () {
	...
	it.skip('setInt on property from tiapp doesnt change value', function () {
	...
	it.skip('setString on property from tiapp doesnt change value', function () {
	...
	it.skip('listProperties contains tiapp properties', function () {
		var properties = Ti.App.Properties.listProperties();
		should(properties).be.a.Object;
	...
	it.skip('removeProperty doesnt remove properties from tiapp', function () {
		var properties = Ti.App.Properties.listProperties();
		should(properties).be.a.Object;
	...
	it.skip('hasProperty returns true for tiapp properties', function () {
