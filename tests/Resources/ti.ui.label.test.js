...
describe('Titanium.UI.Label', function () {
	...
	it('minimumFontSize', function () {
		...
		should(label.minimumFontSize).eql(6);
		should(label.getMinimumFontSize()).eql(6);
		label.minimumFontSize = 12;
		should(label.minimumFontSize).eql(12);
		should(label.getMinimumFontSize()).eql(12);
	});
