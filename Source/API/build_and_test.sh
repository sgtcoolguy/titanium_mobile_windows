...
declare -r TitaniumWindows_API_DISABLE_TESTS="OFF"
...
cmd+=" -DTitaniumWindows_API_DISABLE_TESTS=${TitaniumWindows_API_DISABLE_TESTS}"
...
if [ "${TitaniumWindows_API_DISABLE_TESTS}" != "ON" ]; then
