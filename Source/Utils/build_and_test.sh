...
declare -r TitaniumWindows_Utils_DISABLE_TESTS="OFF"
...
cmd+=" -DTitaniumWindows_Utils_DISABLE_TESTS=${TitaniumWindows_Utils_DISABLE_TESTS}"
...
if [ "${TitaniumWindows_Utils_DISABLE_TESTS}" != "ON" ]; then
