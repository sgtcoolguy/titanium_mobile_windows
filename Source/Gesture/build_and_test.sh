...
declare -r TitaniumWindows_Gesture_DISABLE_TESTS="OFF"
...
cmd+=" -DTitaniumWindows_Gesture_DISABLE_TESTS=${TitaniumWindows_Gesture_DISABLE_TESTS}"
...
if [ "${TitaniumWindows_Gesture_DISABLE_TESTS}" != "ON" ]; then
