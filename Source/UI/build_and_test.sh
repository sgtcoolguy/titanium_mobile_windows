...
declare -r TitaniumWindows_UI_DISABLE_TESTS="OFF"
...
cmd+=" -DTitaniumWindows_UI_DISABLE_TESTS=${TitaniumWindows_UI_DISABLE_TESTS}"
...
if [ "${TitaniumWindows_UI_DISABLE_TESTS}" != "ON" ]; then
