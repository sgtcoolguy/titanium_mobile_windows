...
namespace Titanium
{
	namespace Windows
	{
		...
		class TITANIUMWINDOWS_UI_EXPORT UIElementCollection : public Titanium::Module, public JSExport<UIElementCollection>
		{
		...
		protected:
			::Windows::UI::Xaml::Controls::UIElementCollection^ wrapped__;
