...
declare -r TitaniumWindows_Network_DISABLE_TESTS="OFF"
...
cmd+=" -DTitaniumWindows_Network_DISABLE_TESTS=${TitaniumWindows_Network_DISABLE_TESTS}"
...
if [ "${TitaniumWindows_Network_DISABLE_TESTS}" != "ON" ]; then
