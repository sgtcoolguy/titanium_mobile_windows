...
declare -r TitaniumWindows_App_DISABLE_TESTS="OFF"
...
cmd+=" -DTitaniumWindows_App_DISABLE_TESTS=${TitaniumWindows_App_DISABLE_TESTS}"
...
if [ "${TitaniumWindows_App_DISABLE_TESTS}" != "ON" ]; then
