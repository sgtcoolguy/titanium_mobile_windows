...
namespace Titanium
{
	...
	void MapModule::JSExportInitialize() {
		...
		JSExport<MapModule>::AddValueProperty("ANNOTATION_AZURE", std::mem_fn(&ANNOTATION_AZURE));
		JSExport<MapModule>::AddValueProperty("ANNOTATION_BLUE", std::mem_fn(&ANNOTATION_BLUE));
		JSExport<MapModule>::AddValueProperty("ANNOTATION_CYAN", std::mem_fn(&ANNOTATION_CYAN));
		JSExport<MapModule>::AddValueProperty("ANNOTATION_GREEN", std::mem_fn(&ANNOTATION_GREEN));
		JSExport<MapModule>::AddValueProperty("ANNOTATION_MAGENTA", std::mem_fn(&ANNOTATION_MAGENTA));
		JSExport<MapModule>::AddValueProperty("ANNOTATION_ORANGE", std::mem_fn(&ANNOTATION_ORANGE));
		...
		JSExport<MapModule>::AddValueProperty("ANNOTATION_ROSE", std::mem_fn(&ANNOTATION_ROSE));
		JSExport<MapModule>::AddValueProperty("ANNOTATION_VIOLET", std::mem_fn(&ANNOTATION_VIOLET));
		JSExport<MapModule>::AddValueProperty("ANNOTATION_YELLOW", std::mem_fn(&ANNOTATION_YELLOW));
