...
TEST_F(DatabaseTests, BasicFeatures)
{
	...
	XCTAssertFalse(Titanium.HasProperty("Database"));
	auto Database = js_context.CreateObject(JSExport<Titanium::DatabaseModule>::Class());
	Titanium.SetProperty("Database", Database, {JSPropertyAttribute::ReadOnly, JSPropertyAttribute::DontDelete});
	XCTAssertTrue(Titanium.HasProperty("Database"));
