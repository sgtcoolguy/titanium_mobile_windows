   ...
   */
	...
	public:
		...
		*/
		...
		TITANIUM_PROPERTY_READONLY_DEF(KEYBOARD_TYPE_ASCII);
		TITANIUM_PROPERTY_READONLY_DEF(KEYBOARD_TYPE_DECIMAL_PAD);
		TITANIUM_PROPERTY_READONLY_DEF(KEYBOARD_TYPE_DEFAULT);
		TITANIUM_PROPERTY_READONLY_DEF(KEYBOARD_TYPE_EMAIL);
		TITANIUM_PROPERTY_READONLY_DEF(KEYBOARD_TYPE_NAMEPHONE_PAD);
		TITANIUM_PROPERTY_READONLY_DEF(KEYBOARD_TYPE_NUMBERS_PUNCTUATION);
		TITANIUM_PROPERTY_READONLY_DEF(KEYBOARD_TYPE_NUMBER_PAD);
		TITANIUM_PROPERTY_READONLY_DEF(KEYBOARD_TYPE_PHONE_PAD);
		TITANIUM_PROPERTY_READONLY_DEF(KEYBOARD_TYPE_URL);
		...
		TITANIUM_PROPERTY_READONLY_DEF(TEXT_ELLIPSIZE_TRUNCATE_NONE);
		TITANIUM_PROPERTY_READONLY_DEF(TEXT_ELLIPSIZE_TRUNCATE_CHAR_WRAP);
		TITANIUM_PROPERTY_READONLY_DEF(TEXT_ELLIPSIZE_TRUNCATE_WORD_WRAP);
		TITANIUM_PROPERTY_READONLY_DEF(TEXT_ELLIPSIZE_TRUNCATE_CLIP);
		TITANIUM_PROPERTY_READONLY_DEF(TEXT_ELLIPSIZE_TRUNCATE_START);
		TITANIUM_PROPERTY_READONLY_DEF(TEXT_ELLIPSIZE_TRUNCATE_MIDDLE);
		TITANIUM_PROPERTY_READONLY_DEF(TEXT_ELLIPSIZE_TRUNCATE_END);
		TITANIUM_PROPERTY_READONLY_DEF(TEXT_ELLIPSIZE_TRUNCATE_MARQUEE);
