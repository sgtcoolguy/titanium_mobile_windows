...
namespace Titanium
{
   ...
   */
	...
	private:
		...
		JSValue attribute_type_FONT__;
		JSValue attribute_type_FOREGROUND_COLOR__;
		JSValue attribute_type_BACKGROUND_COLOR__;
		JSValue attribute_type_STRIKETHROUGH_STYLE__;
		JSValue attribute_type_UNDERLINES_STYLE__;
		JSValue attribute_type_LINK__;
		JSValue attribute_type_UNDERLINE_COLOR__;
		JSValue attribute_type_KERN__;
		JSValue attribute_type_STROKE_COLOR__;
		JSValue attribute_type_STROKE_WIDTH__;
		JSValue attribute_type_SHADOW__;
		JSValue attribute_type_WRITING_DIRECTION__;
		JSValue attribute_type_TEXT_EFFECT__;
		JSValue attribute_type_BASELINE_OFFSET__;
		JSValue attribute_type_STRIKETHROUGH_COLOR__;
		JSValue attribute_type_OBLIQUENESS__;
		JSValue attribute_type_EXPANSION__;
		JSValue attribute_type_LINE_BREAK__;
		JSValue attribute_style_UNDERLINE_NONE__;
		JSValue attribute_style_UNDERLINE_SINGLE__;
		JSValue attribute_style_UNDERLINE_THICK__;
		JSValue attribute_style_UNDERLINE_DOUBLE__;
		JSValue attribute_style_UNDERLINE_PATTERN_SOLID__;
		JSValue attribute_style_UNDERLINE_PATTERN_DOT__;
		JSValue attribute_style_UNDERLINE_PATTERN_DASH__;
		JSValue attribute_style_UNDERLINE_PATTERN_DASH_DOT__;
		JSValue attribute_style_UNDERLINE_PATTERN_DASH_DOT_DOT__;
		JSValue attribute_style_UNDERLINE_BY_WORD__;
		JSValue attribute_style_WRITING_DIRECTION_EMBEDDING__;
		JSValue attribute_style_WRITING_DIRECTION_OVERRIDE__;
		JSValue attribute_style_WRITING_DIRECTION_NATURAL__;
		JSValue attribute_style_WRITING_DIRECTION_LEFT_TO_RIGHT__;
		JSValue attribute_style_WRITING_DIRECTION_RIGHT_TO_LEFT__;
		JSValue attribute_style_TEXT_EFFECT_LETTERPRESS__;
		JSValue attribute_style_LINE_BREAK_BY_WORD_WRAPPING__;
		JSValue attribute_style_LINE_BREAK_BY_CHAR_WRAPPING__;
		JSValue attribute_style_LINE_BREAK_BY_CLIPPING__;
		JSValue attribute_style_LINE_BREAK_BY_TRUNCATING_HEAD__;
		JSValue attribute_style_LINE_BREAK_BY_TRUNCATING_TAIL__;
		JSValue attribute_style_LINE_BREAK_BY_TRUNCATING_MIDDLE__;		
