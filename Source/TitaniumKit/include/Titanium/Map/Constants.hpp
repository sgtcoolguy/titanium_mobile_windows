...
#ifndef _TITANIUM_MAP_CONSTANTS_HPP_
#define _TITANIUM_MAP_CONSTANTS_HPP_
...
namespace Titanium
{
	namespace Map
	{
		...
		*/
		enum class TITANIUMKIT_EXPORT OVERLAY_LEVEL {
			ABOVE_LABELS,
			ABOVE_ROADS
		};
		...
		*/
		enum class TITANIUMKIT_EXPORT ANNOTATION_DRAG_STATE {
			END,
			START
		};
		...
		/*!
		  ...
		  @constant YELLOW
		*/
		enum class TITANIUMKIT_EXPORT ANNOTATION_COLOR {
			AZURE,
			BLUE,
			CYAN,
			GREEN,
		...
		*/
		enum class TITANIUMKIT_EXPORT GOOGLE_PLAY_SERVICE_STATE {
			DISABLED,
			INVALID,
			MISSING,
