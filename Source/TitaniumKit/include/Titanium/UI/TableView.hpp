	...
	namespace UI
	{
		...
		*/
		...
		public:
			...
			*/
			virtual void setData(std::vector<JSObject>& data, const std::shared_ptr<ListViewAnimationProperties>& animation) TITANIUM_NOEXCEPT;
			...
			*/
			virtual void appendRow(const TableViewRow_shared_ptr_t row, const std::shared_ptr<ListViewAnimationProperties>& animation) TITANIUM_NOEXCEPT;
			...
			*/
			virtual void appendSection(const TableViewSection_shared_ptr_t section, const std::shared_ptr<ListViewAnimationProperties>& animation) TITANIUM_NOEXCEPT;
			...
			*/
			virtual void deleteRow(const TableViewRow_shared_ptr_t row, const std::shared_ptr<ListViewAnimationProperties>& animation) TITANIUM_NOEXCEPT;
			...
			*/
			virtual void deleteSection(uint32_t section, const std::shared_ptr<ListViewAnimationProperties>& animation) TITANIUM_NOEXCEPT;
			...
			*/
			virtual void insertRowAfter(uint32_t index, JSValue row, const std::shared_ptr<ListViewAnimationProperties>& animation) TITANIUM_NOEXCEPT;
			...
			*/
			virtual void insertSectionAfter(uint32_t index, JSValue section, const std::shared_ptr<ListViewAnimationProperties>& animation) TITANIUM_NOEXCEPT;
			...
			*/
			virtual void insertRowBefore(uint32_t index, JSValue row, const std::shared_ptr<ListViewAnimationProperties>& animation) TITANIUM_NOEXCEPT;
			...
			*/
			virtual void insertSectionBefore(uint32_t index, JSValue section, const std::shared_ptr<ListViewAnimationProperties>& animation) TITANIUM_NOEXCEPT;
			...
			*/
			virtual void scrollToIndex(uint32_t index, const std::shared_ptr<ListViewAnimationProperties>& animation) TITANIUM_NOEXCEPT;
			...
			*/
			virtual void scrollToTop(uint32_t top, const std::shared_ptr<ListViewAnimationProperties>& animation) TITANIUM_NOEXCEPT;
			...
			*/
			virtual void updateRow(uint32_t index, TableViewRow_shared_ptr_t row, const std::shared_ptr<ListViewAnimationProperties>& animation) TITANIUM_NOEXCEPT;
			...
			*/
			virtual void updateSection(uint32_t index, TableViewSection_shared_ptr_t section, const std::shared_ptr<ListViewAnimationProperties>& animation) TITANIUM_NOEXCEPT;
