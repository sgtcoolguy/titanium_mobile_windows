...
__declspec(dllexport) void populateLayoutPoperties(struct InputProperty inputProperty, struct LayoutProperties* layoutProperties, double ppi) {
...
__declspec(dllexport) void layoutPropertiesInitialize(struct LayoutProperties* layoutProperties) {
