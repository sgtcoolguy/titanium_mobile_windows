...
__declspec(dllexport) struct ComputedSize doHorizontalLayout(std::vector<struct Element*> children, double width, double height, bool isWidthSize, bool isHeightSize) {
...
__declspec(dllexport) void measureNodeForHorizontalLayout(struct LayoutProperties layoutProperties, struct Element* element) {
