...
declare -r TitaniumWindows_Platform_DISABLE_TESTS="OFF"
...
cmd+=" -DTitaniumWindows_Platform_DISABLE_TESTS=${TitaniumWindows_Platform_DISABLE_TESTS}"
...
if [ "${TitaniumWindows_Platform_DISABLE_TESTS}" != "ON" ]; then
