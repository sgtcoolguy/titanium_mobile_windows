...
declare -r TitaniumWindows_Blob_DISABLE_TESTS="OFF"
...
cmd+=" -DTitaniumWindows_Blob_DISABLE_TESTS=${TitaniumWindows_Blob_DISABLE_TESTS}"
...
if [ "${TitaniumWindows_Blob_DISABLE_TESTS}" != "ON" ]; then
