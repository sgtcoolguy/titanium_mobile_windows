...
declare -r TitaniumWindows_Media_DISABLE_TESTS="OFF"
...
cmd+=" -DTitaniumWindows_Media_DISABLE_TESTS=${TitaniumWindows_Media_DISABLE_TESTS}"
...
if [ "${TitaniumWindows_Media_DISABLE_TESTS}" != "ON" ]; then
