...
declare -r TitaniumWindows_Map_DISABLE_TESTS="OFF"
...
cmd+=" -DTitaniumWindows_Map_DISABLE_TESTS=${TitaniumWindows_Map_DISABLE_TESTS}"
...
if [ "${TitaniumWindows_Map_DISABLE_TESTS}" != "ON" ]; then
